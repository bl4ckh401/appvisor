  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-accent":
          "linear-gradient(135deg, hsl(262, 83%, 58%) 0%, hsl(292, 84%, 61%) 50%, hsl(322, 85%, 64%) 100%)",
      },
      boxShadow: {
        glow: "0 0 20px hsl(262, 83%, 58%, 0.3)",
        "glow-lg": "0 0 40px hsl(262, 83%, 58%, 0.4)",
        "inner-glow": "inset 0 0 20px hsl(262, 83%, 58%, 0.2)",
      },
    },
  },
